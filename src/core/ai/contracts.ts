...
export type ExecutionState =
  | "REQUESTED" | "CLASSIFIED" | "PLANNED" | "RESEARCHING"
  | "GENERATING" | "VERIFYING" | "POLICY_CHECK"
  | "APPROVAL_REQUIRED" | "APPROVED" | "EXECUTING"
  | "WAITING_TOOL" | "WAITING_EXTERNAL" | "OBSERVING" | "EVALUATING" | "COMPLETED" | "FAILED" | "CANCELLED";
...
export interface Evidence {
  ...
  claim: string;
  source: string;
  sourceTrust: "S0" | "S1" | "S2" | "S3" | "S4" | "S5";
  collectedAt: string;
  verification: "UNVERIFIED" | "PARTIAL" | "VERIFIED" | "CONFLICTING";
  confidence: number;
}
